...
const Hero = () => {
  return (
    <div className="bg min-h-[700px] p-20">
      <Carousel
      ...
      >
        <div className="flex gap-5 relative">
          ...
          <div className="absolute w-[900px] top-20 right-[0px] p-20 bg-white border-4">
            <div className="">
              ...
              <p className="text-justify overflow-hidden">
                ...
                your business growth and partnership. Expertise and passion, we
                craft tailored solutions to elevate your business to new
                heights. Let’s collaborate, innovate, and thrive together in the
                ever-evolving landscape of success.
              </p>
            </div>
