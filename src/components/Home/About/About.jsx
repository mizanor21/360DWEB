...
const About = () => {
  return (
    <div className="about">
      <div className="lg:container lg:mx-auto py-10 lg:py-20">
        <div className="p-5 lg:p-[50px] rounded-md glass grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="">
            <p className="font-[Inter] border-[3px] w-44 font-medium border-[#1d72b8] text-center lg:px-10 py-3 rounded">
              About Us
            </p>
            <h1 className="text-4xl lg:text-5xl  font-[Inter] flex flex-col my-5">
